const Loading = () => {
    return (
        <div className="flex text-center items-center h-screen bg-white">
                <div className="m-auto w-[350px]">
                    ...
                    <div className="pb-5 text-[20px] mt-[25px] text-gray-700 justify-center">
                        <div className="flex justify-center relative w-[190px] mx-auto">
                        ...
                        <div className="flex justify-center relative w-[250px] mx-auto">
